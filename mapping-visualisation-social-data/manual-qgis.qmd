---
title: "Practical guide to mapping and visualisation of crime and social data in QGIS"
...
-   In **Colour ramp**, click the arrow
...
-   We want to display the prevlance of Helminths. In **Value** select the field
    name `sth_prevla`.
-   In **Colour ramp**, under **All Color Ramps**, select the colours
    **YlOrRd**.
...
- Under **Color ramp**, **All Color Ramps**, select **RdYlBu**. The colour palette goes from red to yellow to blue (i.e., low intensity of Helsmiths from red, and higher as blue); therefore, we need to invert the colour palette accordingly by selecting **Invert Colour Ramp** after choosing **RdYlBu**.
...
- Under **Colour ramp**, select **Reds**. The colour palette goes from lightest of reds to the darkest of reds (i.e., lowest intensity of victimisation is represented by lightest of reds, and highest victimisation are the darkest of reds).
